...
func (q *Queries) ListsTransfers(ctx context.Context, arg ListsTransfersParams) ([]Transfer, error) {
	rows, err := q.query(ctx, q.listsTransfersStmt, listsTransfers, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
