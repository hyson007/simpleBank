...
// Source: github.com/hyson007/simpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListsEntries(arg0 context.Context, arg1 db.ListsEntriesParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListsTransfers(arg0 context.Context, arg1 db.ListsTransfersParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
